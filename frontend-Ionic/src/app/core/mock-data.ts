...
export const MOCK_DONATIONS: Donation[] = [
  {
    ...
    description: 'Fruta variada en perfecto estado, preparada para recoger durante el día. Ideal para comedor social o reparto local.',
    quantity: '25 kg',
  ...
  },
  {
    ...
    description: 'Yogures y productos refrigerados con caducidad próxima. Se requiere transporte refrigerado o recogida rápida.',
    quantity: '18 cajas',
