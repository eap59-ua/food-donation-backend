...
export class ApiService {
  ...
  updateDonation(id: string, payload: Partial<CreateDonationPayload>): Observable<Donation> {
    return this.http.put<Donation>(`${this.apiBaseUrl}/donations/${id}`, payload, this.auth.authOptions());
  }
